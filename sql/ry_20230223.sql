...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,103,'admin','若依','00','ry@163.com','15888888888','1','','$2a$10$OvEeS0RKIyEqG0z/xFARtOD.WHci8kKVLHhUVItdAzxvOCiVtGNAW','0','0','127.0.0.1',sysdate(),'admin',sysdate(),'',null,'管理员');
insert into sys_user values(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$6cG.zOwiVodcjqqaccWJVeJ3FwtmS1Ys0VXWDkmI0bj/SKALat6n2','0','0','127.0.0.1',sysdate(),'admin',sysdate(),'',null,'测试员');
...
-- activiti工作流
INSERT INTO `sys_menu` VALUES (5, '流程菜单', 0, 4, 'activiti', NULL,null, 1, 0, 'M', '0', '0', 'activiti:modeler:list', 'cascader', 'admin', '2020-09-13 21:58:54', '', NULL, '');
...
insert into sys_config values(2, '用户管理-账号初始密码',         'sys.user.initPassword',         'Password@123',        'Y', 'admin', sysdate(), '', null, '初始化密码 123456' );
...
CREATE TABLE `act_workflow_formdata`  (
  ...
  `business_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事务key',
  `form_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表单Key',
  `control_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表单id',
  `control_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表单名',
  `control_value` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表单值',
  `task_node_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务节点名称',
  `create_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者姓名',
  `create_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '动态表单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `workflow_leave`  (
  ...
  `type` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请假类型',
  ...
  `attachment_link` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '附件',
  ...
  `create_name` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建者名称',
